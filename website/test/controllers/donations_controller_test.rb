...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { incentive: @donation.incentive, progress: @donation.progress, total: @donation.total } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { incentive: @donation.incentive, progress: @donation.progress, total: @donation.total } }
