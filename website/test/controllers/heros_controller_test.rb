...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { image_url: @hero.image_url, name: @hero.name, string: @hero.string, total: @hero.total, unlocks: @hero.unlocks } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { image_url: @hero.image_url, name: @hero.name, string: @hero.string, total: @hero.total, unlocks: @hero.unlocks } }
